...
namespace Gr2.D1
{
    public partial class Form12 : Form
    {
            ...
            double _x, double _y, double _z, ref double NewX, ref double NewY)
        {
            ...
            NewX = (_A * Lu + _u * (-_B * _v - _C * _w + _u * _x + _v * _y + _w * _z) + (-_A * Lu + _u * (_B * _v + _C * _w - _v * _y - _w * _z) + Lu * _x) *
                Math.Cos(_Theta) + sqrL * (-_C * _v + _B * _w - _w * _y + _v * _z) * Math.Sin(_Theta)) / L;
            NewY = (_B * Lv + _v * (-_A * _u - _C * _w + _u * _x + _v * _y + _w * _z) + (-_B * Lv + _v * (_A * _u + _C * _w - _u * _x - _w * _z) + Lv * _y) *
                Math.Cos(_Theta) + sqrL * (-_C * _u - _A * _w + _w * _x - _u * _z) * Math.Sin(_Theta)) / L;
            NewZ = (_C * Lw + _w * (-_A * _u - _B * _v + _u * _x + _v * _y + _w * _z) + (-_C * Lw + _w * (_A * _u + _B * _v - _u * _x - _v * _y) + Lw * _z) *
                Math.Cos(_Theta) + sqrL * (-_B * _u + _A * _v - _v * _x + _u * _y) * Math.Sin(_Theta)) / L;
            return NewZ;
        }
